    ...
    <div className="container">
      ...
      <div className="row text-center py-6">
        <div className="col layer-2">
          ...
          <a className="btn btn-primary btn-lg" href="index.html">Go back home</a>
        </div>
      </div>
    </div>
