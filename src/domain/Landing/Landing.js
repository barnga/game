...
const Landing = () => (
  <div data-overlay className="bg-primary text-light o-hidden position-relative">
    <div className="position-absolute w-100 h-100 o-hidden top-0">
      ...
      <div className="decoration right bottom scale-3">
        <Svg src={dots6} classNames={'bg-primary-2'} />
      </div>
    ...
    <section className="min-vh-70 o-hidden d-flex flex-column justify-content-center">
      <div className="container">
        <div className="row justify-content-center text-center align-items-center">
          <div className="col-xl-8 col-lg-9 col-md-10 layer-3" data-aos="fade-up" data-aos-delay="500">
    ...
    <div className="divider flip-x">
      <Svg src={divider} classNames={'bg-primary-2'} />
    </div>
  </div>
);
